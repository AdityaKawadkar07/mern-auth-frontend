...
// Action creator for storing user information in localStorage
const storeUserInLocalStorage = (user) => {
  localStorage.setItem('user', JSON.stringify(user));
};

// Action creator for removing user information from localStorage
const removeUserFromLocalStorage = () => {
  localStorage.removeItem('user');
};

// Action creator for retrieving user information from localStorage
...
const authSlice = createSlice({
  ...
  initialState:{
    ...initialState,
    isLoggedIn: !! userFromLocalStorage, // Set isLoggedIn based on the presence of user information in localStorage
